...
const BlogPost = () => {
  ...
  const url = `https://mahadevbookportal.live/blog/${post.slug}`;
  ...
  const jsonLd: object[] = [
    {
      ...
      image: [`https://mahadevbookportal.live/og-image.jpg`],
      datePublished: post.publishedAt,
      dateModified: post.updatedAt,
      author: { "@type": "Organization", name: post.author, url: "https://mahadevbookportal.live" },
      publisher: {
        "@type": "Organization",
        name: "Mahadev Book",
        logo: { "@type": "ImageObject", url: "https://mahadevbookportal.live/favicon.png" },
      },
    ...
    },
    {
      ...
      "@type": "BreadcrumbList",
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "Home", item: "https://mahadevbookportal.live/" },
        { "@type": "ListItem", position: 2, name: "Blog", item: "https://mahadevbookportal.live/blog" },
