...
export const GAMES: GameDef[] = [
  {
    ...
    category: "Sports",
    title: "Online Cricket Betting India 2026 — IPL, T20, ODI Live Odds | MahadevFast",
    h1: "Online Cricket Betting India — IPL 2026, T20 World Cup & Live Odds",
    description: "Play online cricket betting in India on MahadevFast — IPL 2026, T20 World Cup, BBL, PSL, Tests & ODIs. Match-odds, fancy, session, lambi & toss. UPI deposit, INR withdrawal, 24x7 support.",
    ...
    intro: "MahadevFast is India's most trusted online cricket betting platform — bet on every IPL match, T20 World Cup, BBL, PSL, Tests and ODIs with the best live odds in INR.",
    image: sportCricket,
    alt: "Bet on online cricket IPL 2026 live with MahadevFast India",
    features: [
    ...
    sections: [
      { h2: "How to Bet on Live Cricket Matches Online", body: "Get your MahadevFast ID via WhatsApp, deposit ₹100 minimum via UPI, and place your first match-odds bet within 2 minutes. We support session, lambi, fancy and toss markets ball-by-ball." },
      { h2: "Best Online Sports Betting Platform for Beginners", body: "MahadevFast is built for first-timers — clean exchange interface, real INR balance, instant withdrawal, and 24x7 Hindi support to walk you through your first bet." },
    ...
    faq: [
      ...
      { q: "How fast are cricket bet payouts?", a: "Most cricket bet payouts settle to your MahadevFast wallet within seconds of match settlement. UPI withdrawal: 5–15 minutes." },
  ...
  },
  {
    ...
    title: "Play Teen Patti Online Real Money India — Live 24x7 | MahadevFast",
    h1: "Play Teen Patti Online Real Money — Live Indian Card Game",
    description: "Play Teen Patti online real money India on MahadevFast — live dealers 24x7, AA Bonus, side bets, ₹100 minimum. UPI deposit & instant INR withdrawal. India's #1 Teen Patti site.",
    ...
    intro: "Teen Patti is India's favourite 3-card game. Play live, against real dealers, 24x7 on MahadevFast — with AA Bonus, side bets and big jackpots, all in INR.",
    image: gameTeenpatti,
    alt: "Play Teen Patti online real money India on MahadevFast live casino",
    features: [
    ...
    sections: [
      { h2: "How to Play Teen Patti Online with MahadevFast", body: "Get your MahadevFast ID via WhatsApp, deposit ₹100 minimum via UPI, and join any live Teen Patti table. Bet from ₹10 per hand. Win in real INR, withdraw to any Indian bank." },
    ...
    faq: [
      { q: "Can I play Teen Patti for real money in India?", a: "Yes — get a MahadevFast ID via WhatsApp and play live Teen Patti with INR deposits. 18+ only." },
  ...
  },
  {
    ...
    category: "Live Casino",
    title: "Play Andar Bahar Online India — Live Real Money 24x7 | MahadevFast",
    h1: "Play Andar Bahar Online — Live Indian Card Game Real Money",
    description: "Play Andar Bahar online real money India on MahadevFast — live dealers, side bets, ₹100 min deposit. Instant UPI withdrawal in INR. Classic Indian casino game 24x7.",
    keywords: "andar bahar online, play andar bahar real money, live andar bahar india, andar bahar app, andar bahar website india",
    intro: "Andar Bahar is the simplest, fastest, most loved Indian casino game. Play live on MahadevFast — real dealers, real INR, 24x7.",
    image: gameAndar,
    alt: "Play live Andar Bahar online India real money on MahadevFast",
    features: [
    ...
    sections: [
      { h2: "How to Play Andar Bahar Online", body: "Pick Andar (inside) or Bahar (outside). Dealer reveals cards alternately until your side matches. Get your MahadevFast ID, deposit ₹100 via UPI, and join any live table." },
    ...
    faq: [
      { q: "Is Andar Bahar online safe?", a: "Yes — MahadevFast uses certified live tables with real dealers and encrypted transactions." },
  ...
  },
  {
    ...
    shortName: "Roulette",
    category: "Live Casino",
    title: "Play Online Roulette India Real Money — European & Lightning | MahadevFast",
    h1: "Online Roulette India — Live European, Lightning & Auto Roulette",
    description: "Play online Roulette India real money on MahadevFast — European, Lightning & Auto Roulette tables 24x7. ₹100 min deposit, INR withdrawal via UPI. Live HD dealers.",
    keywords: "online roulette india, live roulette real money, european roulette online, lightning roulette india, MahadevFast roulette",
    intro: "Spin live European, Lightning and Auto Roulette tables on MahadevFast — real dealers, real INR, 24x7.",
    image: gameRoulette,
    alt: "Play live online Roulette India real money on MahadevFast casino",
    features: [
    ...
    sections: [
      { h2: "How to Play Online Roulette in India", body: "Get your MahadevFast ID via WhatsApp, deposit ₹100 via UPI, choose any Roulette table, place chips on numbers/colours/columns and spin. Wins credit instantly to your INR balance." },
  ...
  },
  {
    ...
    category: "Live Casino",
    title: "Play Dragon Tiger Online India — Live Card Game Real Money | MahadevFast",
    h1: "Dragon Tiger Online India — Fast Live Card Game",
    description: "Play Dragon Tiger online India on MahadevFast — fastest live card game, ₹100 min deposit, instant INR withdrawal via UPI. 30-second rounds, real dealers 24x7.",
    keywords: "dragon tiger online, play dragon tiger india, live dragon tiger real money, dragon tiger casino india",
    intro: "Dragon Tiger is the fastest live casino game — 30-second rounds, single card per side, easy 50/50 bets. Play on MahadevFast in INR 24x7.",
    image: gameDragon,
    alt: "Dragon Tiger live casino card game online India on MahadevFast",
    features: [
    ...
    sections: [
      { h2: "How to Play Dragon Tiger Online", body: "Pick Dragon or Tiger (or Tie). Dealer draws one card on each side — highest card wins. Get your MahadevFast ID via WhatsApp and play in INR with ₹100 min deposit." },
    ...
    faq: [
      ...
      { q: "Is Dragon Tiger online safe on MahadevFast?", a: "Yes — certified live tables, real dealers, encrypted transactions." },
    ],
  },
];
