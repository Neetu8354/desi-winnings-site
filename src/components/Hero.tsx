  ...
  return (
    <section id="home" className="relative overflow-hidden">
      <div className="absolute inset-0">
        <img src={heroImg} alt="Play IPL 2026 online cricket betting on MahadevFast — India's #1 betting ID" className="w-full h-full object-cover opacity-60" width={1920} height={1080} fetchPriority="high" decoding="async" />
